  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hotel as @hotel" do
        ...
        post :create, {:hotel => { "title" => "invalid value" }}, valid_session
        assigns(:hotel).should be_a_new(Hotel)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hotel" do
        ...
        Hotel.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => hotel.to_param, :hotel => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the hotel as @hotel" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Hotel.any_instance.stub(:save).and_return(false)
        put :update, {:id => hotel.to_param, :hotel => { "title" => "invalid value" }}, valid_session
        assigns(:hotel).should eq(hotel)
      end
